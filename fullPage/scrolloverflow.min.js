...
!(function (t, i, e) {
   ...
   function o(t, e, s) {
      ...
      return (
         ...
         'h' == t
            ? (s === !0 && ((o.style.cssText += ';height:7px;left:2px;right:2px;bottom:0'), (n.style.height = '100%')), (o.className = 'iScrollHorizontalScrollbar'))
            : (s === !0 && ((o.style.cssText += ';width:7px;bottom:2px;top:2px;right:1px'), (n.style.width = '100%')), (o.className = 'iScrollVerticalScrollbar')),
   ...
   function n(e, s) {
      ...
      if (
         ...
         this.options.interactive &&
            ...
            this.options.disablePointer || (h.addEvent(this.indicator, h.prefixPointerEvent('pointerdown'), this), h.addEvent(t, h.prefixPointerEvent('pointerup'), this)),
         ...
         (o.getTime =
            ...
            (o.momentum = function (t, i, s, o, n, r) {
               ...
               return (
                  ...
                  (h = t + ((c * c) / (2 * r)) * (l < 0 ? -1 : 1)),
                  (a = c / r),
                  h < o ? ((h = n ? o - (n / 2.5) * (c / 8) : o), (l = e.abs(h - t)), (a = l / c)) : h > 0 && ((h = n ? (n / 2.5) * (c / 8) : 0), (l = e.abs(t) + h), (a = l / c)),
   ...
   (s.prototype = {
         ...
         if (this.enabled && (!this.initiated || h.eventType[t.type] === this.initiated)) {
            ...
            (this.initiated = h.eventType[t.type]),
               ...
               this.options.useTransition && this.isInTransition
                  ? (this._transitionTime(), (this.isInTransition = !1), (s = this.getComputedPosition()), this._translate(e.round(s.x), e.round(s.y)), this._execEvent('scrollEnd'))
      ...
      _move: function (t) {
         if (this.enabled && h.eventType[t.type] === this.initiated) {
            ...
            var i,
               ...
               c = h.getTime();
            if (
               ((this.pointX = r.pageX), (this.pointY = r.pageY), (this.distX += a), (this.distY += l), (o = e.abs(this.distX)), (n = e.abs(this.distY)), !(c - this.endTime > 300 && o < 10 && n < 10))
            ) {
               if (
         ...
         if (this.enabled && h.eventType[t.type] === this.initiated) {
            ...
            if (((this.isInTransition = 0), (this.initiated = 0), (this.endTime = h.getTime()), !this.resetPosition(this.options.bounceTime))) {
               ...
               if (
                  (this.options.momentum &&
                     ...
                     ((i = this.hasHorizontalScroll
                        ? h.momentum(this.x, this.startX, o, this.maxScrollX, this.options.bounce ? this.wrapperWidth : 0, this.options.deceleration)
                        : { destination: n, duration: 0 }),
                     (s = this.hasVerticalScroll
                        ? h.momentum(this.y, this.startY, o, this.maxScrollY, this.options.bounce ? this.wrapperHeight : 0, this.options.deceleration)
               ...
               return n != this.x || r != this.y
                  ? ((n > 0 || n < this.maxScrollX || r > 0 || r < this.maxScrollY) && (p = h.ease.quadratic), void this.scrollTo(n, r, c, p))
      ...
      _translate: function (t, i) {
         if (
            (this.options.useTransform
               ...
               : ((t = e.round(t)), (i = e.round(i)), (this.scrollerStyle.left = t + 'px'), (this.scrollerStyle.top = i + 'px')),
            (this.x = t),
            (this.y = i),
            this.indicators)
         )
      ...
      _initEvents: function (i) {
         ...
         e(t, 'orientationchange', this),
            ...
            this.options.disableMouse || (e(this.wrapper, 'mousedown', this), e(s, 'mousemove', this), e(s, 'mousecancel', this), e(s, 'mouseup', this)),
            h.hasPointer &&
            ...
            h.hasTouch && !this.options.disableTouch && (e(this.wrapper, 'touchstart', this), e(s, 'touchmove', this), e(s, 'touchcancel', this), e(s, 'touchend', this)),
      ...
      _wheel: function (t) {
         if (this.enabled) {
            ...
            if (
               ...
               1 === t.deltaMode ? ((i = -t.deltaX * this.options.mouseWheelSpeed), (s = -t.deltaY * this.options.mouseWheelSpeed)) : ((i = -t.deltaX), (s = -t.deltaY));
            ...
            if (((i *= this.options.invertWheelDirection), (s *= this.options.invertWheelDirection), this.hasVerticalScroll || ((i = s), (s = 0)), this.options.snap))
               return (o = this.currentPage.pageX), (n = this.currentPage.pageY), i > 0 ? o-- : i < 0 && o++, s > 0 ? n-- : s < 0 && n++, void this.goToPage(o, n);
                  ...
                  if (this.options.snap === !0)
                     for (s = e.round(c / 2), o = e.round(p / 2); l > -this.scrollerWidth; ) {
                        for (this.pages[h] = [], t = 0, n = 0; n > -this.scrollerHeight; )
                           (this.pages[h][t] = { x: e.max(l, this.maxScrollX), y: e.max(n, this.maxScrollY), width: c, height: p, cx: l - s, cy: n - o }), (n -= p), t++;
                        (l -= c), h++;
                     }
                  else
      ...
      _nearestSnap: function (t, i) {
         ...
         return (
            s == this.currentPage.pageX && ((s += this.directionX), s < 0 ? (s = 0) : s >= this.pages.length && (s = this.pages.length - 1), (t = this.pages[s][0].x)),
      ...
      _key: function (t) {
         if (this.enabled) {
            var i,
               ...
               l = 0.25;
            switch (
               (this.options.useTransition && this.isInTransition && ((i = this.getComputedPosition()), this._translate(e.round(i.x), e.round(i.y)), (this.isInTransition = !1)),
      ...
      _animate: function (t, i, e, s) {
         function o() {
            ...
            return m >= p
               ...
               : ((m = (m - c) / e), (f = s(m)), (d = (t - a) * f + a), (u = (i - l) * f + l), n._translate(d, u), void (n.isAnimating && r(o)));
         }
         var n = this,
            a = this.x,
            l = this.y,
            ...
            if (this.initiated) {
               if (
                  ...
                  (this.scroller.x == s.x && this.scroller.y == s.y) ||
                     ((this.scroller.directionX = 0), (this.scroller.directionY = 0), (this.scroller.currentPage = s), this.scroller.scrollTo(s.x, s.y, o, this.scroller.options.bounceEasing));
               }
            ...
            (a.options = null),
               (a.init = function (o, n) {
                  return (
                     (a.options = o),
                     (a.iscrollOptions = n),
                     'complete' === i.readyState && (s(), e.fn.fullpage.shared.afterRenderActions()),
