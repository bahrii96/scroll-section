   ...
   e.fn.fullpage = function (Z) {
      function q(n, t) {
         ...
         Z.autoScrolling && !Z.scrollBar
            ? (wt.css({ overflow: 'hidden', height: '100%' }), Q(Qt.recordHistory, 'internal'), zt.css({ '-ms-touch-action': 'none', 'touch-action': 'none' }), o.length && lt(o.position().top))
            : (wt.css({ overflow: 'visible', height: 'initial' }), Q(!1, 'internal'), zt.css({ '-ms-touch-action': '', 'touch-action': '' }), ut(zt), o.length && wt.scrollTop(o.position().top)),
      ...
      function Ae(e) {
         e.find(D).after('<div class="' + G + '"></div><div class="' + K + '"></div>'),
            '#fff' != Z.controlArrowColor &&
               (e.find(_).css('border-color', 'transparent transparent transparent ' + Z.controlArrowColor),
            ...
            if (((n = e(c).eq(r)), !n.hasClass(u))) {
               ...
               x.length && ((v = x.data('anchor')), (p = x.index())),
                  Et &&
                     ...
                     Z.resetSliders && xt.resetSliders && xt.resetSliders.apply({ localIsResizing: Lt, leavingSection: g }),
                     on(h),
                     en(n),
                     nn(n),
                     Dn(w, b - 1),
         ...
         if (Fe(t)) {
            ...
            (no = r.y),
               ...
               i.find(D).length && o.abs(eo - to) > o.abs($t - no)
                  ? !kt && o.abs(eo - to) > ($.outerWidth() / 100) * Z.touchSensitivity && (eo > to ? Dt.m.right && de(i) : Dt.m.left && fe(i))
                  : Z.autoScrolling && Et && o.abs($t - no) > ($.height() / 100) * Z.touchSensitivity && ($t > no ? De('down') : no > $t && De('up'));
         }
      }
      function Fe(e) {
      ...
      function je(e) {
         ...
         return (
            e.outerHeight() > It ? ((o || r) && 'bottom' !== r) || (t = i) : (o || (Lt && e.is(':last-child'))) && (t = i),
      ...
      function qe(n, t, o) {
         if ('undefined' != typeof n && n.length) {
            ...
            (l.activeSection.is(n) && !Lt) ||
               ...
               (l.activeSlide.length && ((i = l.activeSlide.data('anchor')), (r = l.activeSlide.index())),
               (e.isFunction(Z.onLeave) && !l.localIsResizing && Z.onLeave.call(l.activeSection, l.leavingSection, l.sectionIndex + 1, l.yMovement) === !1) ||
                  (vt('parallax', 'apply', l),
                  Z.autoScrolling &&
      ...
      function Je(n) {
         return (
            n.isMovementUp ? n.activeSection.before(n.activeSection.nextAll(S)) : n.activeSection.after(n.activeSection.prevAll(S).get().reverse()),
            lt(e(y).position().top),
            Ne(),
      ...
      function Ke(n) {
         n.wrapAroundElements &&
            ...
            (n.isMovementUp ? e(w).before(n.wrapAroundElements) : e(b).after(n.wrapAroundElements),
            lt(e(y).position().top),
            Ne(),
            (n.sectionIndex = n.element.index(S)),
            (n.leavingSection = n.activeSection.index(S) + 1));
      ...
      function An(n, t, o) {
         ...
         return (
            ...
            Z.onSlideLeave.call(r.prevSlide, r.anchorLink, r.sectionIndex + 1, r.prevSlideIndex, r.direction, r.slideIndex) === !1
               ? void (kt = !1)
      ...
      function On(e, n, t) {
         ...
         if (Z.css3) {
            ...
            e.animate({ scrollLeft: o.round(i.left) }, Z.scrollingSpeed, Z.easing, function () {
               t && kn(n);
            });
      }
      function Rn(e, n) {
      ...
      function Gn(e, n, t, o) {
         ...
         Z.anchors.length &&
            !Z.lockAnchors &&
            (e ? ('undefined' != typeof t && (i = t), 'undefined' == typeof n && (n = e), (Tt = n), Un(i + '/' + n)) : 'undefined' != typeof e ? ((Tt = n), Un(t)) : Un(t)),
            Jn();
      }
      function Un(e) {
      ...
      function _n() {
         t.addEventListener
            ? (t.removeEventListener('mousewheel', Ve, !1), t.removeEventListener('wheel', Ve, !1), t.removeEventListener('MozMousePixelScroll', Ve, !1))
      ...
      function rt(e) {
         ...
         return (
            ...
            Rt && Fe(e) && Z.scrollBar && 'undefined' != typeof e.touches && ((n.y = e.touches[0].pageY), (n.x = e.touches[0].pageX)),
            n
         );
      }
      function at(e, n) {
      ...
      function ft() {
         lt(0),
            ...
            e(H).css({ width: '' }),
            zt.css({ height: '', position: '', '-ms-touch-action': '', 'touch-action': '' }),
      ...
      function St() {
         return e('html').hasClass(d)
            ? void yt('error', 'Fullpage.js can only be initialized once and you are doing it multiple times!')
            : (Z.continuousVertical &&
                 (Z.loopTop || Z.loopBottom) &&
                 ((Z.continuousVertical = !1), yt('warn', 'Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled')),
              ...
              !Z.continuousVertical ||
                 ...
                 ((Z.continuousVertical = !1), yt('warn', 'Scroll bars (`scrollBar:true` or `autoScrolling:false`) are mutually exclusive with `continuousVertical`; `continuousVertical` disabled')),
              Z.scrollOverflow &&
                 !Z.scrollOverflowHandler &&
                 ((Z.scrollOverflow = !1), yt('error', 'The option `scrollOverflow:true` requires the file `scrolloverflow.min.js`. Please include it before fullPage.js.')),
              void e.each(Z.anchors, function (n, t) {
                 ...
                 (i.length || o.length) &&
                    (yt('error', 'data-anchor tags can not have the same value as any `id` element on the site (or `name` element for IE).'),
