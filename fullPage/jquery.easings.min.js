            ...
            (f.style.cssText = 'background-color:rgba(1,1,1,.5)'),
               ...
               (d.hsla.to = function (e) {
                  ...
                  var t,
                     ...
                     d = 0.5 * u;
                  return (
                     (t = h === o ? 0 : a === o ? (60 * (s - n)) / l + 360 : s === o ? (60 * (n - a)) / l + 120 : (60 * (a - s)) / l + 240),
                           ...
                           (u.fn[i] = function (s) {
                              ...
                              return 'undefined' === r
                                 ...
                                 : ('function' === r && ((s = s.call(this, u)), (r = t.type(s))),
                                   null == s && a.empty ? this : ('string' === r && ((n = h.exec(s)), n && (s = u + parseFloat(n[2]) * ('+' === n[1] ? 1 : -1))), (l[a.idx] = s), this[o](l)));
                           });
                     });
               }),
               m(o, function (e, i) {
               ...
               e.fn.extend({
                  ...
                  toggleClass: function (i, a, s, n, r) {
                     return 'boolean' == typeof a || a === t
                        ? s
                           ? e.effects.animateClass.call(this, a ? { add: i } : { remove: i }, s, n, r)
         ...
         (function () {
            function s(t, i, a, s) {
               return (
                  ...
                  ('number' == typeof i || e.fx.speeds[i]) && ((s = a), (a = i), (i = {})),
               ...
               createWrapper: function (t) {
                  ...
                  return (
                     ...
                     'static' === t.css('position')
                        ? (a.css({ position: 'relative' }), t.css({ position: 'relative' }))
                  ...
                  effect: function () {
                     ...
                     return e.fx.off || (!o && !h)
                        ...
                        ? r === !1
                           ? this.each(t)
                           : this.queue(r || 'fx', t)
                        : h.call(this, { options: a, duration: a.duration, callback: a.complete, mode: a.mode });
                  },
                  _show: e.fn.show,
                  show: function (e) {
